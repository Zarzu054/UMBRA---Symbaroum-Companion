export type MonsterTraitTier = "I" | "II" | "III";

export type MonsterTraitCatalogEntry = {
  nombre: string;
  fuente: "Libro Básico" | "Códice de monstruos";
  pagina: number;
  resumen: string;
  introduccion: string;
  niveles?: Record<MonsterTraitTier, string>;
  tags: string[];
};

function trait(
  nombre: string,
  fuente: MonsterTraitCatalogEntry["fuente"],
  pagina: number,
  resumen: string,
  introduccion: string,
  niveles: MonsterTraitCatalogEntry["niveles"],
  tags: string[]
): MonsterTraitCatalogEntry {
  return { nombre, fuente, pagina, resumen, introduccion, niveles, tags };
}

function unlevelledTrait(
  nombre: string,
  pagina: number,
  resumen: string,
  introduccion: string,
 ...
 */
export const MONSTER_TRAIT_CATALOG: readonly MonsterTraitCatalogEntry[] = [
  trait(
    "Alado",
    "Libro Básico",
    197,
    "La criatura posee alas y una capacidad de vuelo cada vez más versátil.",
    "El rasgo representa alas de ave, insecto u otra naturaleza y las maniobras que la criatura puede realizar con ellas.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    197,
    "Garras, colmillos, cuernos o aguijones convierten el cuerpo de la criatura en un arma.",
    "La habilidad Combate sin armas puede mejorar el Arma natural de una criatura.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    197,
    "Los ataques naturales están cubiertos de un ácido persistente.",
    "Si la potencia del ácido supera la armadura del objetivo, causa todo su daño; si no, no causa ninguno. Se elimina gastando una acción y superando Inteligente. Requiere Sangre ácida al mismo nivel o superior.",
    {
  ...
  trait(
    "Ataque de corrupción",
    "Libro Básico",
    198,
    "Las armas naturales transmiten Corrupción temporal cuando hieren.",
    "Solo las criaturas más corruptas pueden transmitir la mancha oscura a través de sus ataques.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    198,
    "La criatura daña un atributo en lugar de la Resistencia.",
    "Normalmente afecta a Fuerte o Tenaz; si el perfil no lo indica, lo decide el DJ. El daño penaliza todas las tiradas del atributo, se cura con normalidad y mata si lo reduce a cero. Requiere Forma espiritual.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    198,
    "Piel, escamas o quitina proporcionan armadura natural.",
    "La armadura natural no es Incómoda y no admite otra protección encima, aunque Combate con armadura sí puede aumentar su valor.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    198,
    "Una mente colectiva se reparte entre numerosos cuerpos.",
    "El enjambre no queda destruido hasta que se elimina a todos sus integrantes.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    198,
    "La criatura proyecta veneno como un ataque a distancia.",
    "Si impacta, la víctima queda envenenada salvo que supere [Fuerte←Inteligente]. El efecto dura hasta aplicar un antídoto y superar Inteligente. Requiere Venenoso al mismo nivel o superior.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    198,
    "Un espíritu puede manifestarse físicamente para actuar sobre la materia.",
    "La criatura domina su Forma espiritual hasta poder adoptar un cuerpo durante periodos cada vez más largos.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    199,
    "La criatura es un espíritu inmaterial difícil de afectar con medios físicos.",
    "Puede atravesar obstáculos, pero no cruzar masas de agua, ni siquiera por puentes, barcos o el aire. Da acceso a Daño alternativo, Forma corpórea y Terrorífico.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    199,
    "Un aura helada paraliza a quienes combaten junto a la criatura.",
    "La criatura proyecta un frío sobrenatural sobre quienes se encuentran a distancia cuerpo a cuerpo.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    199,
    "La mirada o la voz de la criatura anula la voluntad de sus víctimas.",
    "Las víctimas hipnotizadas son incapaces de actuar hasta que sea demasiado tarde.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    199,
    "Un espíritu anima un cadáver que no siente dolor ni sana como un ser vivo.",
    "El cuerpo carece de Umbral de dolor y el espíritu es expulsado cuando el cadáver queda destruido.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    199,
    "La criatura recupera Resistencia automáticamente cada turno.",
    "Debe tener una debilidad —armas mágicas, fuego o ácido, ataques sagrados o impíos— cuyo daño no puede regenerar, aunque sí puede curarlo por otros medios.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    200,
    "El gran tamaño absorbe daño, potencia los golpes y penaliza la Defensa.",
  ...
  trait(
    ...
    "Libro Básico",
    200,
    "La sangre corrosiva rocía a quien hiere a la criatura cuerpo a cuerpo.",
    "Quien la hiera en combate cuerpo a cuerpo debe superar Defensa o sufrir el ácido. Se elimina gastando una acción y superando Inteligente para lavarlo.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    200,
    "La criatura crea redes resistentes para inmovilizar a sus presas.",
    "Una víctima atrapada no puede moverse y tira dos veces para realizar cualquier acción; si falla cualquiera de las dos tiradas, la acción fracasa.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    200,
    "La criatura obliga a retroceder o paraliza de miedo a sus víctimas.",
    "Requiere Forma espiritual. Las víctimas pueden repetir la tirada una vez por turno para librarse del miedo.",
    {
  ...
  trait(
    ...
    "Libro Básico",
    200,
    "Las armas naturales y ataques sin armas inoculan veneno.",
    "Cuando el ataque hiere, la víctima evita el veneno con [Fuerte←Inteligente]. El efecto continúa hasta aplicar un antídoto y superar Inteligente.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    164,
    "La criatura atrapa y aplasta a quienes hiere con sus armas naturales.",
    "Tras causar daño con un arma natural, intenta agarrar como reacción. La víctima evita la presa con [Ágil←Diestro] y, si queda atrapada, trata de escapar cada turno con [Fuerte←Fuerte]. Mientras mantiene una presa, la criatura pierde una acción de combate por turno y víctima.",
    {
  ...
  trait(
    "Acaparador de corrupción",
    "Códice de monstruos",
    164,
    "Una criatura consumida almacena corrupción y la gasta para torcer tiradas.",
    "Puede guardar hasta la mitad de Tenaz, redondeando hacia arriba, y pierde un punto al día. Cada punto gastado como reacción puede forzar que un enemigo repita una tirada para evitar una capacidad, defenderse, atacar o determinar un efecto, quedándose con el peor resultado.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    164,
    "La criatura exhala fuego, frío, ácido, rayos u otra energía letal.",
    "Puede combinarse con Daño alternativo, Ataque de corrupción o Venenoso si ese rasgo está al mismo nivel o superior.",
    {
  ...
  unlevelledTrait(
    "Anfibio",
    164,
    "La criatura vive y combate con normalidad tanto en el agua como en tierra.",
    "Respira aire y agua, no sufre penalizadores por combate acuático ni recibe daño por esfuerzo o falta de oxígeno mientras permanece sumergida.",
    ["movilidad", "agua"]
  ),
  trait(
    "Aparición",
    "Códice de monstruos",
    164,
    "El espíritu posee cuerpos ajenos y puede saltar a un nuevo huésped al ser derrotado.",
    "Requiere Forma espiritual I. Exorcismo expulsa a la criatura del huésped.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    165,
    "El ataque atraviesa armadura para aplicar veneno, corrupción u otro efecto.",
    "No causa daño normal. Se compara su valor con la armadura: si la protección es igual o superior, falla; si es menor, se aplica el efecto secundario indicado en el perfil.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    165,
    "Un aura elemental daña a quienes permanezcan cuerpo a cuerpo con la criatura.",
    "El aura deja un rastro fácil de seguir. Puede combinarse con Daño alternativo, Ataque de corrupción o Venenoso si el otro rasgo está al mismo nivel o superior.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    165,
    "La criatura refuerza su armadura natural protegiéndose con placas o concha.",
    "Requiere Duro I. Cada nivel permite duplicar la armadura natural en circunstancias más favorables.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    165,
    "Una criatura poderosa va acompañada por aliados subordinados.",
    "La criatura principal debe tener desafío Complicado como mínimo. La naturaleza de sus compañeros se decide al crear el perfil.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    165,
    "La criatura convoca intrusos demoníacos del Ultramundo.",
    "Solo está disponible para criaturas consumidas por la corrupción. Los convocados obedecen órdenes audibles y desaparecen al morir la convocante o al terminar la escena.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    166,
    "Los golpes derriban, lanzan por los aires y destrozan fortificaciones.",
    "Cuando Robusto participa en la tirada enfrentada, tanto atacante como defensor suman +2 a Fuerte por cada nivel que posean.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    166,
    "El tamaño colosal hace a la criatura lenta, devastadora y casi invulnerable.",
    "Requiere Robusto III.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    166,
    "La criatura atrapa, engulle y digiere a sus víctimas.",
    "Requiere Descomunal I. Puede alojar una víctima, tres con Descomunal II o seis con Descomunal III, y puede escupir una como acción gratuita. Una víctima engullida recibe 2 de daño por turno que ignora armadura.",
    {
  ...
  unlevelledTrait(
    "Diminuto",
    167,
    "El tamaño insignificante dificulta considerarlo una amenaza prioritaria.",
    "Mientras haya otros blancos, un enemigo debe superar [Tenaz←Discreto] para atacarlo. No se aplica si es el único objetivo o ya ha herido al atacante, y termina cuando usa una habilidad, poder u otro rasgo que revele claramente el peligro.",
    ["evasión", "tamaño"]
  ),
  trait(
    "Embestida",
    "Códice de monstruos",
    167,
    "La criatura arrolla a todo el que se encuentre en su trayectoria.",
    "Requiere Robusto al mismo nivel. Robusto añade +2 por nivel tanto al daño como a Fuerte para atacante y defensor. Acróbata permite evitarla con [Ágil←Fuerte]; un éxito no detiene la carga.",
    {
  ...
  unlevelledTrait(
    "Espíritu libre",
    167,
    "La criatura está fuera del conflicto entre Wyrtha, Wielda y Wratha.",
    "Es inmune a la corrupción y no puede aprender poderes místicos ni rituales. Sí puede utilizar artefactos, y hacerlo no le provoca corrupción.",
    ["espíritu", "inmunidad"]
  ),
  trait(
    "Garras prensiles",
    "Códice de monstruos",
    167,
    "Las garras sujetan y arrastran a la presa hacia la criatura.",
    "Una víctima apresada puede actuar, pero no moverse. En turnos posteriores se resuelve [Fuerte←Fuerte] para arrastrarla o liberarla.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    167,
    "Las armas naturales de la criatura transmiten enfermedades.",
    "Toda víctima herida por un arma natural debe superar Fuerte o contrae la enfermedad correspondiente.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    167,
    "La criatura o sus larvas penetran en el cuerpo de la víctima.",
    "La extracción requiere Medicus y una tirada de Inteligente. Cada intento fallido o invasivo puede herir gravemente a la víctima e ignora armadura.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    168,
    "La criatura desaparece de la vista, aunque aún deja huellas y ruido.",
    "No puede ser objetivo directo mientras sea invisible. Puede revelarse con efectos de área, polvo, harina, velas espectrales o Forma verdadera; percibirla exige [Atento←Discreto].",
    {
  ...
  unlevelledTrait(
    "Lengua apresadora",
    168,
    "Una lengua larga muerde, sujeta y arrastra desde lejos.",
    "Ataca hasta a dos acciones de movimiento de distancia y usa el daño de mordisco. Si la víctima tiene al menos un nivel menos de Robusto, la criatura puede acercarla con [Fuerte←Fuerte]. Puede combinarse con Devorador o Abrazo aplastante.",
    ["alcance", "arrastre"]
  ),
  trait(
    "Lucha a muerte",
    "Códice de monstruos",
    168,
    "La criatura realiza un último ataque al morir.",
    "El efecto se activa como reacción cuando su Resistencia llega a cero.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    168,
    "La criatura transforma su cuerpo para obtener rasgos adaptativos.",
    "Puede elegir entre Alado, Aliento mortal, Anfibio, Arma natural, Ataque ácido, Caparazón, Diminuto, Duro, Escupitajo venenoso, Garras prensiles, Lengua apresadora, Robusto, Telaraña, Tunelador y Venenoso. La forma dura hasta cambiarla o sufrir Forma verdadera.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    168,
    "Varias cabezas o miembros actúan y reciben daño por separado.",
    "Cada cabeza dispone de una acción y una reserva de Resistencia propias; es necesario destruirlas todas. El desgaste reduce la eficacia de Duro y Robusto en los niveles superiores.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    169,
    "La criatura levanta una barrera viva que bloquea y ataca.",
    "El muro exige dos movimientos para rodearlo o bloquea una abertura. Usa las reglas de edificios con Dureza 10, Rotura 5 y Fortificación 5; dura la escena y, si es destruido, no puede crearse otro hasta el día siguiente.",
    {
  ...
  unlevelledTrait(
    "Observador",
    169,
    "La criatura percibe el entorno en todas direcciones.",
    "Sus sentidos cubren 360 grados: no puede ser flanqueada y sus enemigos no obtienen ventaja por rodearla.",
    ["sentidos", "flanqueo"]
  ),
  unlevelledTrait(
    "Poder colectivo",
    169,
    "Un grupo obtiene poderes místicos en función del número de integrantes.",
    "El colectivo usa un poder por turno además de las acciones individuales, en la iniciativa más alta del grupo. Con 1–3 miembros no tiene poder; con 4–6, uno a Principiante; con 7–10, uno a Adepto; con 11–20, dos a Adepto; y con 21 o más, dos a Maestro. La concentración solo se rompe si pierde tres miembros en el mismo turno.",
    ["colectivo", "magia"]
  ),
  trait(
    "Recio",
    "Códice de monstruos",
    169,
    "La criatura posee una reserva de Resistencia extraordinaria.",
    "El Umbral de dolor sigue siendo Fuerte/2; solo aumenta la Resistencia máxima.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    169,
    "La magia tiene dificultades para afectar a la criatura y puede rebotar.",
    "Se aplica a cualquier poder místico que intente dañarla o afectarla.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    170,
    "La criatura cautiva, muerde y drena la sangre de una víctima.",
    "El trance comienza con [Tenaz←Tenaz]. Mientras drena, repite la tirada enfrentada cada turno; herir a la criatura permite romper el efecto con [Tenaz−daño].",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    170,
    "La criatura percibe brotes de corrupción y puede rastrear su origen.",
    "La sensibilidad funciona con Atento y mejora con la intensidad del brote.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    170,
    "La criatura detecta seres vivos a través de obstáculos y tierra.",
    "No detecta muertos vivientes ni espíritus. Una criatura que intente ocultarse debe superar [Discreto←Atento].",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    170,
    "Al morir, la criatura deja tras de sí vengadores vinculados a su naturaleza.",
    "La criatura debe tener desafío Complicado como mínimo. Los sucesores son de la misma clase o una opción coherente y, si son consumidos por la corrupción, el original también debe serlo.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    171,
    "La criatura excava, ataca desde el subsuelo y abre sumideros.",
    "Mientras se desplaza bajo tierra evita los ataques gratuitos al pasar o acercarse.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    171,
    "La criatura encadena ataques adicionales a gran velocidad.",
    "El ataque inicial puede ser cuerpo a cuerpo, a distancia o místico; los ataques adicionales no pueden usar capacidades activas.",
    {
  ...
  trait(
    ...
    "Códice de monstruos",
    171,
    "Una toxina limita las acciones o paraliza completamente a la víctima.",
    "Cada ataque que cause daño obliga a tirar Fuerte. El veneno continúa hasta aplicar un antídoto y superar Inteligente.",
    {
  ...
  unlevelledTrait(
    "Visión nocturna",
    171,
    "La criatura usa ecolocalización y actúa con normalidad en oscuridad total.",
    "Los pulsos acústicos le permiten percibir objetos, movimiento y seres invisibles sin depender de la vista; la oscuridad no le impone penalizadores mientras conserve este sentido.",
    ["sentidos", "oscuridad"]
  )
] as const;

export const UNLEVELLED_MONSTER_TRAIT_NAMES = new Set(
  MONSTER_TRAIT_CATALOG.filter((entry) => !entry.niveles).map((entry) => entry.nombre)
);

export function formatMonsterTraitDetail(entry: MonsterTraitCatalogEntry): string {
  if (!entry.niveles) return entry.introduccion;
