...
function buildCapabilityEntry(item) {
    return {
        id: item.id,
        tipo: item.tipo,
        nombre: item.nombre,
...
function buildSimpleEntries(items, tipo, fuente, resumenBase) {
...
function buildArchetypeEntries() {
...
const COMPENDIUM_ONLY_PROFESSIONS = [
    {
...
function buildProfessionEntries() {
    ...
    const linkedEntries = [...professions.entries()]
    ...
    const detailedEntries = COMPENDIUM_ONLY_PROFESSIONS.map((profession) => {
...
function buildCanonicalProfessionEntries() {
    const capabilityIdByName = new Map([...SYMBAROUM_ABILITIES, ...SYMBAROUM_MYSTIC_POWERS, ...SYMBAROUM_RITUALS]
        .map((entry) => [slugify(entry.nombre), entry.id]));
    ...
    const traits = [
        {
            ...
            detalle: "I: puede volar y reposicionarse con ventaja táctica. II: el vuelo le permite evitar parte del combate trabado y castigar desde ángulos difíciles. III: combina velocidad, altura y control del espacio para convertir la movilidad aérea en una ventaja constante.",
        ...
        },
        {
            ...
            detalle: "El rasgo representa ataques corporales integrados en la anatomía del monstruo. Sus distintos niveles mejoran el valor ofensivo y sirven de base para muchos otros rasgos, como Venenoso, Ataque de corrupción o Abrazo aplastante.",
        ...
        },
        {
            ...
            detalle: "I/II/III: como reacción, el ácido es débil, moderado o potente y provoca 3/4/5 puntos de daño durante 3/4/5 turnos. Hace falta gastar una acción y superar una tirada de Inteligente para lavar el ácido con agua, tierra o algo similar.",
        ...
        },
        {
            ...
            detalle: "I/II/III: cualquier víctima que sufra al menos 1 punto de daño de uno de sus ataques recibe además 1D4/1D6/1D8 de Corrupción temporal. Representa bestias o abominaciones tan contaminadas que su mera herida ya infecta.",
        ...
        },
        {
            ...
            detalle: "Requiere Forma espiritual. I/II/III: el arma natural inflige 3/4/5 puntos de daño alternativo que ignoran armadura, normalmente contra Fuerte o Tenaz. Si el atributo llega a cero, la víctima muere.",
        ...
        },
        {
            ...
            detalle: "I/II/III: la criatura obtiene una protección natural de 2/3/4. No puede llevar protección adicional sobre esa armadura natural, pero sí combinarla con Combate con armadura.",
        ...
        },
        {
            ...
            detalle: "I/II/III: el enjambre sufre la mitad, la mitad o una cuarta parte del daño de todos los ataques. Sus niveles también ajustan cuándo huye por instinto de supervivencia y cómo resiste ataques mentales.",
        ...
        },
        {
            ...
            detalle: "Requiere Venenoso al mismo nivel o superior. I/II/III: como acción activa, el veneno provoca 2/3/4 puntos de daño durante 2/3/4 turnos si la víctima no supera [Fuerte←Inteligente]. Se neutraliza con antídoto y una tirada de Inteligente.",
        ...
        },
        {
            ...
            detalle: "I: se vuelve corpóreo durante un turno y puede actuar con ataques físicos. II: puede mantenerse así todo el tiempo que quiera y usar equipo que portara al morir. III: interactúa con el mundo físico sin perder la mayoría de ventajas de su estado espiritual.",
        ...
        },
        {
            ...
            detalle: "I/II/III: puede atravesar obstáculos y sufre la mitad de daño de armas físicas; a niveles altos también reduce el daño de armas mágicas o alquímicas. El rasgo da acceso a Daño alternativo, Forma corpórea y Terrorífico.",
        ...
        },
        {
            ...
            detalle: "I: los personajes a distancia cuerpo a cuerpo deben superar Tenaz o quedan paralizados. II: además sufren 2 de daño que ignora armadura. III: el aura aprieta aún más la tirada enfrentada y multiplica el riesgo para quienes se acerquen.",
            tags: ["aura", "parálisis"]
        },
        {
            nombre: "Hipnótico",
            ...
            detalle: "I: afecta a una víctima con [Tenaz←Tenaz]. II: puede afectar a todas las víctimas de su canto o sonido. III: el efecto persiste hasta superar la tirada o recibir daño.",
            tags: ["control", "mente"]
        },
        {
            ...
            detalle: "I: es inmune a veneno, enfermedad, shock y dolor, pero no se cura de forma natural. II: además solo sufre la mitad de daño de ataques físicos normales. III: también reduce magia y alquimia, mientras armas mágicas o benditas siguen siendo plenamente efectivas.",
        ...
        },
        {
            ...
            detalle: "I/II/III: regenera 2/3/4 puntos de Resistencia por turno. Cada monstruo debe tener un punto débil definido, como fuego, ácido, armas mágicas, ataques sagrados o impíos.",
        ...
        },
        {
            ...
            detalle: "I/II/III: ignora 2/3/4 puntos de daño por golpe además de su armadura, puede añadir +2/+3/+4 daño una vez por turno y su Defensa se calcula sobre [Ágil−2/−3/−4].",
        ...
        },
        {
            ...
            detalle: "I/II/III: quien la hiera a cuerpo a cuerpo debe superar Defensa o sufrir 3/4/5 puntos de daño durante 3/4/5 turnos. Se limpia gastando una acción y superando una tirada de Inteligente.",
            tags: ["ácido", "reacción"]
        },
        {
            nombre: "Telaraña",
            ...
            detalle: "I: cruzar la telaraña exige [Ágil←Inteligente] o se queda atrapado. II: además puede lanzar una red como acción activa. III: la red es semiconsciente y golpea hasta tres veces por turno con los mismos efectos.",
            tags: ["control", "presa"]
        },
        {
            nombre: "Terrorífico",
            ...
            detalle: "Requiere Forma espiritual. I: obliga a una víctima a gastar sus acciones retrocediendo si falla [Tenaz←Tenaz]. II: extiende el efecto a todos los cercanos. III: quienes no puedan huir quedan encogidos de miedo en el sitio.",
            tags: ["miedo", "control"]
        },
        {
            nombre: "Venenoso",
            ...
            detalle: "I/II/III: si el ataque consigue herir y la víctima falla [Fuerte←Inteligente], sufre 2/3/4 puntos de daño durante 2/3/4 turnos hasta que reciba antídoto y una tirada de Inteligente.",
            tags: ["veneno", "ataque"]
        },
        {
...
function buildMonsterRuleEntries() {
    return [
        ...
        },
        {
            ...
            detalle: "Los grupos principiantes rondan 50 XP y afrontan aventuras limitadas; los experimentados, unas 100 XP y retos locales; los veteranos, unas 200 XP y amenazas regionales; y los héroes, 300 XP o más, con artefactos abundantes y conflictos globales.",
            fuente: "Códice de monstruos",
            pagina: 178,
        ...
        },
        {
            ...
            detalle: "Las pautas sugieren principiantes principalmente en Ambria y Davokar la Luminosa, experimentados con incursiones crecientes en la Oscura, veteranos habituados a la Luminosa pero probados en la Oscura, y héroes enfrentados a zonas completamente consumidas por corrupción.",
            fuente: "Códice de monstruos",
            pagina: 180,
...
export const RULE_SUMMARY_ENTRIES = [
    {
...
export function canonicalizeCompendiumSourceName(source) {
    return SOURCE_CANONICAL_MAP[source] ?? source;
}
const SOURCE_PDF_PATHS = {
...
const SUMMARY_PDF_PAGE_LOOKUPS = {
    rules: {
        "acciones-especiales-de-combate": 5,
        "apuntar-a-una-parte-del-cuerpo": 25,
        "apuntar-alto-o-bajo": 25,
...
export function getCompendiumSummaryLink(entry) {
    const buildSummaryUrl = (documentKey, sectionLabel) => {
