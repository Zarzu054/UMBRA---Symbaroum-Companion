...
export function readCharacterSheetBackground(scope) {
...
export function useCharacterSheetBackground(scope) {
    const [preference, setPreference] = useState(() => readCharacterSheetBackground(scope));
    useEffect(() => {
