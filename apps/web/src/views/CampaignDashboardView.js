...
export function CampaignDashboardView({ user, ensureAccessToken }) {
    ...
    return (_jsxs("main", { className: "campaign-dashboard", children: [!selectedCampaign ? (_jsxs("section", { className: "panel campaign-list-panel", children: [_jsxs("div", { className: "row-actions", children: [_jsxs("div", { children: [_jsx("h1", { children: "Campa\u00F1as" }), _jsx("p", { className: "section-help", children: "Notas compartidas, notas del DJ y personajes vinculados." })] }), _jsxs("div", { className: "toolbar", children: [isDirector ? (_jsx("button", { type: "button", onClick: () => {
                                ...
                                }, children: [_jsx("strong", { children: campaign.name }), _jsx("span", { children: campaign.setting || campaign.summary || "Sin ambientacion" }), _jsxs("span", { children: [campaign.members.length, " miembros"] }), _jsxs("span", { children: [campaign.characters.length, " personajes vinculados"] })] }, campaign.id))), !isLoading && campaigns.length === 0 ? (_jsx("p", { className: "section-help", children: "Aun no hay campa\u00F1as accesibles." })) : null] })] })) : null, selectedCampaign ? (_jsxs("section", { className: "campaign-main", children: [_jsxs("section", { className: "panel", children: [_jsxs("div", { className: "row-actions", children: [_jsxs("div", { children: [_jsx("h2", { children: selectedCampaign.name }), selectedCampaign.summary ? _jsx("p", { className: "section-help", children: selectedCampaign.summary }) : null] }), _jsxs("div", { className: "campaign-header-actions", children: [_jsx("button", { type: "button", className: "subtle-button", onClick: () => {
                                                    setSelectedCampaignId(null);
                                                    setSelectedSheetId(null);
                                                    setActiveSection(isDirector ? "dmNotes" : "sharedNotes");
                                    ...
                                    }), selectedCampaign.characters.length === 0 ? (_jsx("p", { className: "section-help", children: "Todavia no hay personajes vinculados." })) : null] }), selectedCampaign.experienceLog.length > 0 ? (_jsxs("section", { className: "campaign-experience-history", children: [_jsx("h4", { children: "Historial de experiencia" }), _jsx("div", { className: "cards", children: selectedCampaign.experienceLog.slice(0, 8).map((entry) => (_jsxs("article", { className: "card", children: [_jsxs("strong", { children: ["+", entry.amount, " PX \u00B7 ", entry.characterName] }), _jsx("span", { children: entry.reason }), _jsxs("span", { children: [formatDate(entry.createdAt), " \u00B7 ", entry.grantedByEmail] })] }, entry.id))) })] })) : null] })) : null, isDirector && activeSection === "artifacts" ? (_jsxs("section", { className: "panel", children: [_jsxs("div", { className: "row-actions", children: [_jsxs("div", { children: [_jsx("h3", { children: "Artefactos m\u00EDsticos" }), _jsx("p", { className: "section-help", children: "Solo se muestran los artefactos que el DJ ha incluido en esta campa\u00F1a." })] }), _jsx("button", { type: "button", disabled: isSaving, onClick: () => {
                                            setArtifactError(null);
