...
export function CharacterBuilderView({ character, busy = false, onBackToCharacters, onOpenSheet, onSave, backLabel = "Volver a personajes", sheetLabel = "Abrir hoja", saveLabel = "Guardar constructor", onBindMysticArtifact, onAspireProfession, onRemoveProfessionAspiration, onRequestProfession, onLeaveProfession, onOpenCompendiumCapability, professionRemovalLabel = "Abandonar profesión" }) {
    ...
    return (_jsxs("section", { className: "character-builder-page unified-sheet", children: [_jsxs("section", { className: "character-builder-shell campaign-sheet-card", children: [_jsxs("div", { className: "character-builder-sticky-controls", children: [_jsxs("header", { className: "character-builder-header-band module-sticky-header module-sticky-header--single-row", children: [_jsxs("div", { className: "unified-sheet-portrait", children: [_jsx("div", { className: "unified-sheet-portrait-ring" }), _jsx("div", { className: "unified-sheet-portrait-content", children: _jsx("span", { children: String(draft.identidad.arquetipo || character.archetype || "C").slice(0, 1) }) })] }), _jsxs("div", { className: "character-builder-identity", children: [_jsx("h2", { className: "unified-sheet-title", children: draft.identidad.nombrePersonaje || character.name }), _jsx("p", { className: "unified-sheet-inline-subtitle", children: subtitle })] }), _jsxs("div", { className: "toolbar character-builder-toolbar", children: [_jsx("button", { type: "button", className: "subtle-button", onClick: onBackToCharacters, children: backLabel }), _jsx("button", { type: "button", className: "subtle-button", onClick: onOpenSheet, children: sheetLabel }), _jsx("button", { type: "button", onClick: () => void handleSave(), disabled: busy || isSaving || bindingArtifactId !== null, children: isSaving ? "Guardando..." : saveLabel })] })] }), _jsx("div", { className: "unified-sheet-tabs character-builder-tabs", children: BUILDER_TABS.map((tab) => (_jsx("button", { type: "button", className: activeTab === tab.id ? "is-active" : "", onClick: () => setActiveTab(tab.id), children: tab.label }, tab.id))) })] }), error ? (_jsx("section", { className: "panel error-list", children: _jsx("p", { children: error }) })) : null, _jsx("section", { className: "character-builder-stage", children: _jsxs("section", { className: "character-builder-layout", children: [activeTab === "resumen" ? (_jsxs("section", { className: "character-builder-panel campaign-sheet-card", children: [_jsxs("div", { className: "row-actions", children: [_jsx("h3", { children: "Constructor" }), _jsx("span", { className: "meta-text", children: "Edicion narrativa y progreso de PX" })] }), _jsxs("div", { className: "character-builder-xp-grid", children: [_jsxs("article", { className: "character-builder-xp-card", children: [_jsx("span", { children: "PX total" }), _jsx("strong", { children: draft.progreso.experienciaTotal })] }), _jsxs("article", { className: "character-builder-xp-card", children: [_jsxs("div", { className: "character-builder-xp-card-heading", children: [_jsx("span", { children: "PX gastada" }), _jsx("button", { type: "button", className: "character-builder-xp-info-button", "aria-label": "Ver detalle de PX gastada", title: "Ver detalle de gastos", onClick: () => setIsXpDetailsOpen(true), children: "i" })] }), _jsx("strong", { children: effectiveSpent })] }), _jsxs("article", { className: "character-builder-xp-card", children: [_jsx("span", { children: "PX disponible" }), _jsx("strong", { children: effectiveAvailable })] })] }), _jsxs("div", { className: "character-builder-summary-notes", children: [_jsxs("p", { children: [_jsx("strong", { children: "PX concedidos:" }), " el total lo gestiona el director de juego desde la campa\u00F1a. El constructor solo permite invertir los puntos disponibles."] }), _jsxs("p", { children: [_jsx("strong", { children: "Origen del PX gastado:" }), " ", experience.spentFromCapabilities, " en capacidades y poderes + ", experience.spentFromRituals, " en rituales + ", experience.spentFromBlessings, " en bendiciones", artifactBindingXpSpent > 0 ? ` + ${artifactBindingXpSpent} en vínculos de artefactos` : "", rerollSpentTotal > 0 ? ` + ${rerollSpentTotal} en repeticiones de dados` : "", "."] }), _jsxs("p", { children: [_jsx("strong", { children: "Rituales y rasgos:" }), " los rituales cuestan 10 PX cada uno; los rasgos y las cargas no modifican autom\u00E1ticamente el total concedido."] })] })] })) : null, activeTab === "identidad" ? (_jsxs("section", { className: "character-builder-panel campaign-sheet-card", children: [_jsx("div", { className: "row-actions", children: _jsx("h3", { children: "Identidad" }) }), _jsxs("div", { className: "form-grid", children: [_jsxs("label", { className: "field", children: [_jsx("span", { children: "Nombre del personaje" }), _jsx("input", { value: draft.identidad.nombrePersonaje, onChange: (event) => updateIdentityField("nombrePersonaje", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Nombre del jugador" }), _jsx("input", { value: draft.identidad.nombreJugador, onChange: (event) => updateIdentityField("nombreJugador", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Marcador especial" }), _jsxs("label", { className: "checkbox-row", children: [_jsx("input", { type: "checkbox", checked: draft.identidad.esFamiliar, onChange: (event) => updateIdentityField("esFamiliar", event.target.checked) }), _jsx("span", { children: "Es familiar (empieza con 20 PX)" })] })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Raza" }), _jsx("input", { value: draft.identidad.raza, onChange: (event) => updateIdentityField("raza", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Cultura" }), _jsx("input", { value: draft.identidad.cultura, onChange: (event) => updateIdentityField("cultura", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Arquetipo" }), _jsx("input", { value: draft.identidad.arquetipo, onChange: (event) => updateIdentityField("arquetipo", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Ocupaci\u00F3n descriptiva" }), _jsx("input", { value: draft.identidad.profesion, onChange: (event) => updateIdentityField("profesion", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Edad" }), _jsx("input", { value: draft.identidad.edad, onChange: (event) => updateIdentityField("edad", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Apariencia" }), _jsx("input", { value: draft.identidad.apariencia, onChange: (event) => updateIdentityField("apariencia", event.target.value) })] }), _jsxs("label", { className: "field field-span-2", children: [_jsx("span", { children: "Objetivo personal" }), _jsx("input", { value: draft.identidad.objetivoPersonal, onChange: (event) => updateIdentityField("objetivoPersonal", event.target.value) })] }), _jsxs("label", { className: "field field-span-2", children: [_jsx("span", { children: "Trasfondo" }), _jsx("textarea", { rows: 6, value: draft.identidad.trasfondo, onChange: (event) => updateIdentityField("trasfondo", event.target.value) })] })] }), _jsxs("section", { className: "profession-goal-picker", children: [_jsxs("div", { children: [_jsx("h4", { children: "Objetivos profesionales" }), _jsx("p", { className: "section-help", children: "Puedes aspirar a varias profesiones. Consulta la pesta\u00F1a Profesiones para ver el progreso de cada requisito." })] }), (character.professionMemberships ?? []).length > 0 ? (_jsx("div", { className: "toolbar", children: (character.professionMemberships ?? []).map((membership) => _jsx("span", { className: `profession-state profession-state--${membership.effectiveState}`, children: membership.professionName }, membership.id)) })) : null, onAspireProfession ? (_jsxs("div", { className: "inline-row", children: [_jsxs("label", { className: "field", children: [_jsx("span", { children: "Nueva aspiraci\u00F3n" }), _jsx("select", { value: selectedProfessionGoalId, onChange: (event) => setSelectedProfessionGoalId(event.target.value), children: SYMBAROUM_PROFESSIONS.filter((profession) => !(character.professionMemberships ?? []).some((membership) => membership.professionId === profession.id)).map((profession) => _jsx("option", { value: profession.id, children: profession.name }, profession.id)) })] }), _jsx("button", { type: "button", disabled: !selectedProfessionGoalId || professionBusyId === selectedProfessionGoalId, onClick: () => void runProfessionAction(selectedProfessionGoalId, () => onAspireProfession(selectedProfessionGoalId)), children: "Marcar objetivo" })] })) : null] })] })) : null, activeTab === "profesiones" ? (_jsxs("section", { className: "character-builder-panel campaign-sheet-card profession-builder-panel", children: [_jsx("div", { className: "row-actions", children: _jsxs("div", { children: [_jsx("h3", { children: "Profesiones avanzadas" }), _jsx("p", { className: "section-help", children: "Marca varios objetivos y completa todos sus requisitos. Para solicitar el ingreso, al menos una capacidad requerida debe estar en maestro." })] }) }), _jsx("div", { className: "profession-builder-list", children: SYMBAROUM_PROFESSIONS.map((profession) => {
                                    ...
                                    }, children: "Solicitar ingreso" })) : null, selectedProfessionMembership?.state === "active" && onLeaveProfession ? (_jsx("button", { type: "button", className: "destructive-button", disabled: professionBusyId === selectedProfessionDetails.id, onClick: () => {
