...
function getInitialCharacterXp(sheet) {
...
export function CharacterBuilderView({ character, busy = false, onBackToCharacters, onOpenSheet, onSave, backLabel = "Volver a personajes", sheetLabel = "Abrir hoja", saveLabel = "Guardar constructor" }) {
    ...
    const sessionExperience = useMemo(() => Math.max(0, draft.progreso.experienciaTotal - initialCharacterXp - experience.extraFromBurdens), [draft.progreso.experienciaTotal, experience.extraFromBurdens, initialCharacterXp]);
