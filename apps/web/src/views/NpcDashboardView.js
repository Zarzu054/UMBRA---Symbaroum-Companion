...
function NpcEditorModal({ controller, onClose }) {
    ...
    return (_jsx("section", { className: "modal-backdrop", onClick: onClose, children: _jsxs("div", { className: "panel modal-panel monster-modal-panel npc-editor-modal", onClick: (event) => event.stopPropagation(), children: [_jsxs("div", { className: "row-actions", children: [_jsxs("div", { children: [_jsx("h2", { children: controller.selectedNpcId ? "Editar PNJ" : "Crear PNJ" }), _jsx("p", { className: "section-help", children: "Tres profundidades: notas, bloque rapido o hoja completa con constructor." })] }), _jsxs("div", { className: "toolbar", children: [_jsx("button", { type: "button", disabled: controller.isSaving, onClick: () => void handleSave(), children: controller.isSaving ? "Guardando..." : "Guardar PNJ" }), _jsx("button", { type: "button", onClick: onClose, children: "Cerrar" })] })] }), controller.error ? _jsx("p", { className: "error", children: controller.error }) : null, _jsxs("div", { className: "monster-editor-layout", children: [_jsxs("section", { className: "monster-builder-card", children: [_jsxs("div", { className: "form-grid", children: [_jsxs("label", { className: "field", children: [_jsx("span", { children: "Nombre" }), _jsx("input", { value: draft.name, onChange: (event) => controller.updateField("name", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Profundidad" }), _jsxs("select", { value: draft.depth, onChange: (event) => controller.updateDepth(event.target.value), children: [_jsx("option", { value: "notes", children: "Solo notas" }), _jsx("option", { value: "stat_block", children: "Bloque rapido" }), _jsx("option", { value: "full_sheet", children: "Hoja completa" })] })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Raza" }), _jsx("input", { value: draft.race, onChange: (event) => controller.updateField("race", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Arquetipo" }), _jsx("input", { value: draft.archetype, onChange: (event) => controller.updateField("archetype", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Ocupacion" }), _jsx("input", { value: draft.occupation, onChange: (event) => controller.updateField("occupation", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Faccion" }), _jsx("input", { value: draft.faction, onChange: (event) => controller.updateField("faction", event.target.value) })] }), _jsxs("label", { className: "field field-span-2", children: [_jsx("span", { children: "Etiquetas" }), _jsx("input", { value: draft.labels.join(", "), placeholder: "mercader, ordo magica, informante", onChange: (event) => controller.updateLabels(event.target.value) })] }), _jsxs("label", { className: "field field-span-2", children: [_jsx("span", { children: "Resumen" }), _jsx("input", { value: draft.summary, onChange: (event) => controller.updateField("summary", event.target.value) })] }), _jsxs("label", { className: "field field-span-2", children: [_jsx("span", { children: "Notas" }), _jsx("textarea", { rows: 6, value: draft.notes, onChange: (event) => controller.updateField("notes", event.target.value) })] })] }), draft.depth !== "notes" ? (_jsxs(_Fragment, { children: [_jsx("div", { className: "section-title", children: "Bloque rapido" }), _jsxs("div", { className: "form-grid", children: [_jsxs("label", { className: "field", children: [_jsx("span", { children: "Ataque" }), _jsx("input", { value: draft.statBlock?.attack ?? "", onChange: (event) => controller.updateStatBlockField("attack", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Da\u00F1o" }), _jsx("input", { value: draft.statBlock?.damage ?? "", onChange: (event) => controller.updateStatBlockField("damage", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Defensa" }), _jsx("input", { value: draft.statBlock?.defense ?? "", onChange: (event) => controller.updateStatBlockField("defense", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Armadura" }), _jsx("input", { value: draft.statBlock?.armor ?? "", onChange: (event) => controller.updateStatBlockField("armor", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Robustez" }), _jsx("input", { value: draft.statBlock?.toughness ?? "", onChange: (event) => controller.updateStatBlockField("toughness", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Umbral" }), _jsx("input", { value: draft.statBlock?.painThreshold ?? "", onChange: (event) => controller.updateStatBlockField("painThreshold", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Movimiento" }), _jsx("input", { value: draft.statBlock?.movement ?? "", onChange: (event) => controller.updateStatBlockField("movement", event.target.value) })] })] }), _jsx("div", { className: "attributes-grid", children: MONSTER_ATTRIBUTE_KEYS.map((attribute) => (_jsxs("label", { className: "attribute-box", children: [_jsx("span", { children: MONSTER_ATTRIBUTE_LABELS[attribute] }), _jsx("input", { type: "number", min: 1, max: 20, value: draft.statBlock?.attributes[attribute] ?? 10, onChange: (event) => controller.updateStatBlockAttribute(attribute, Number(event.target.value || 0)) })] }, attribute))) }), _jsxs("div", { className: "form-grid", children: [_jsxs("label", { className: "field field-span-2", children: [_jsx("span", { children: "Rasgos" }), _jsx("textarea", { rows: 3, value: (draft.statBlock?.traits ?? []).join("\n"), onChange: (event) => controller.updateStatBlockField("traits", event.target.value.split("\n").map((entry) => entry.trim()).filter(Boolean)) })] }), _jsxs("label", { className: "field field-span-2", children: [_jsx("span", { children: "Acciones" }), _jsx("textarea", { rows: 3, value: (draft.statBlock?.actions ?? []).join("\n"), onChange: (event) => controller.updateStatBlockField("actions", event.target.value.split("\n").map((entry) => entry.trim()).filter(Boolean)) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Tactica" }), _jsx("textarea", { rows: 3, value: draft.statBlock?.tactics ?? "", onChange: (event) => controller.updateStatBlockField("tactics", event.target.value) })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Debilidad" }), _jsx("textarea", { rows: 3, value: draft.statBlock?.weakness ?? "", onChange: (event) => controller.updateStatBlockField("weakness", event.target.value) })] })] })] })) : null] }), _jsxs("section", { className: "monster-builder-card", children: [_jsx("h3", { children: "Vista previa" }), draft.depth === "notes" ? (_jsxs("article", { className: "campaign-sheet-card npc-notes-preview", children: [_jsxs("div", { className: "row-actions", children: [_jsx("strong", { children: draft.name || "PNJ sin nombre" }), _jsx("span", { className: "compendium-chip", children: DEPTH_LABELS[draft.depth] })] }), _jsx("p", { className: "meta-text", children: draft.faction || "Sin faccion" }), _jsx("p", { children: draft.summary || "Añade un resumen para definir el rol narrativo del PNJ." }), _jsx("p", { className: "section-help", children: draft.notes || "Las notas largas del PNJ apareceran aqui." })] })) : (renderNpcStatBlock({
...
export function NpcDashboardView({ ensureAccessToken }) {
    ...
    function openCreateModal(depth = "notes") {
