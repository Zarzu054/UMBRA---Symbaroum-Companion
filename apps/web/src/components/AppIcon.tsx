export type AppIconName = "menu" | "user" | "sun" | "moon" | "monitor" | "close" | "arrow-left" | "palette" | "fit-width" | "fit-page";

export function AppIcon({ name, size = 18 }: { name: AppIconName; size?: number }) {
  const paths: Record<AppIconName, React.ReactNode> = {
    menu: <><path d="M4 7h16M4 12h16M4 17h16" /></>,
    user: <><circle cx="12" cy="8" r="3.25" /><path d="M5.5 20c.7-4 3-6 6.5-6s5.8 2 6.5 6" /></>,
    ...
    "fit-width": <><path d="M4 6v12M20 6v12M5 12h14M8 9l-3 3 3 3M16 9l3 3-3 3" /></>,
    "fit-page": <><rect x="7" y="3" width="10" height="18" rx="1.5" /><path d="M3 8V5a2 2 0 0 1 2-2h2M21 8V5a2 2 0 0 0-2-2h-2M3 16v3a2 2 0 0 0 2 2h2M21 16v3a2 2 0 0 1-2 2h-2" /></>
  };
