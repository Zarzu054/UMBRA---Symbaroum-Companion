...
export function AppTopNavigation({ items, currentTitle, userEmail, roleLabel, onLogout }) {
    ...
    return (_jsxs("header", { className: "app-top-navigation", children: [_jsxs("div", { className: "app-top-navigation-inner", children: [_jsx("button", { type: "button", className: "app-brand", onClick: () => items[0] && selectItem(items[0]), "aria-label": "Ir al inicio de UMBRA", children: "UMBRA" }), _jsx("span", { className: "app-current-title", children: currentTitle }), !isMobile ? (_jsx("nav", { className: "app-primary-navigation", "aria-label": "Navegaci\u00F3n principal", children: items.map((item) => (_jsx("button", { type: "button", className: item.active ? "is-active" : "", "aria-current": item.active ? "page" : undefined, onClick: () => selectItem(item), children: item.label }, item.id))) })) : null, _jsxs("button", { ref: triggerRef, type: "button", className: "app-navigation-menu-trigger", "aria-label": "Abrir navegaci\u00F3n", "aria-haspopup": "dialog", "aria-expanded": isOpen, onClick: () => setIsOpen((current) => !current), children: [_jsx(AppIcon, { name: isMobile ? "menu" : "user" }), _jsx("span", { children: isMobile ? "Menú" : userEmail })] })] }), isOpen ? (_jsxs("div", { ref: menuRef, className: "app-navigation-menu", role: "dialog", "aria-label": "Navegaci\u00F3n y preferencias", children: [_jsxs("div", { className: "app-navigation-menu-heading", children: [_jsxs("div", { children: [_jsx("strong", { children: userEmail }), _jsx("span", { children: roleLabel })] }), _jsx("button", { type: "button", className: "icon-button", "aria-label": "Cerrar navegaci\u00F3n", onClick: () => setIsOpen(false), children: _jsx(AppIcon, { name: "close" }) })] }), isMobile ? (_jsx("nav", { className: "app-navigation-menu-modules", "aria-label": "M\u00F3dulos", children: items.map((item) => (_jsx("button", { type: "button", className: item.active ? "is-active" : "", "aria-current": item.active ? "page" : undefined, onClick: () => selectItem(item), children: item.label }, item.id))) })) : null, _jsxs("div", { className: "app-navigation-menu-section", children: [_jsx("span", { className: "app-navigation-menu-label", children: "Apariencia" }), _jsx(AppearanceSelector, {})] }), _jsx("button", { type: "button", className: "app-logout-button", onClick: () => void onLogout(), children: "Cerrar sesi\u00F3n" })] })) : null] }));
}
