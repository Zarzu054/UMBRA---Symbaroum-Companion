...
export function UnifiedCharacterSheet({ title, subtitle, sheet, editable, busy = false, onSave, onBack, onOpenBuilder, onUseArtifactAbility, backgroundPreferenceScope, onOpenCompendiumCapability }) {
