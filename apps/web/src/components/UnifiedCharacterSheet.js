...
export function UnifiedCharacterSheet({ title, subtitle, sheet, editable, busy = false, onSave, onBack, onOpenBuilder, onUseArtifactAbility, backgroundPreferenceScope, collapsibleHistory = false, onOpenCompendiumCapability, professionMemberships = [], enforceProfessionRestrictions = false }) {
