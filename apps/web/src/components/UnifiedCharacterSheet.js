...
const ACTION_TAB_IDS = ["all", "favorites", "attacks", "powers", "actions", "free", "reactions", "other", "special"];
...
export function UnifiedCharacterSheet({ title, subtitle, sheet, editable, busy = false, onSave, onBack, onOpenBuilder, backgroundPreferenceScope, onOpenCompendiumCapability }) {
    ...
    function renderTabStage(className = "unified-sheet-stage campaign-sheet-card") {
        return (_jsxs("section", { className: className, children: [_jsx("nav", { className: "unified-sheet-tabs", children: [
                        ...
                        ["notes", "Notas"]
                                            ...
                                            ["other", "Otras"]
                                        ].map(([tab, label]) => (_jsx("button", { type: "button", className: activeActionTab === tab ? "is-active" : "", onClick: () => setActiveActionTab(tab), children: label }, tab))) }), _jsxs("div", { className: "campaign-sheet-actions", children: [activeActionTab === "special" ? (_jsxs(_Fragment, { children: [specialActionEntries.map((entry) => (_jsxs("div", { className: "campaign-action-button campaign-action-button--row", children: [_jsxs("div", { className: "campaign-action-main", children: [_jsx("div", { className: "campaign-action-title-row", children: _jsx("button", { type: "button", className: "campaign-action-name-button", onClick: () => openRuleCompendiumDetail(entry), children: entry.nombre }) }), _jsxs("span", { className: "campaign-action-source-note", children: [entry.fuente, entry.pagina ? ` p. ${entry.pagina}` : ""] })] }), _jsx("div", { className: "campaign-action-slot", children: _jsx("span", { className: "compendium-chip", children: "Regla" }) }), _jsx("div", { className: "campaign-action-slot is-damage", children: _jsx("span", { "aria-hidden": "true", className: "campaign-action-slot-placeholder" }) })] }, entry.id))), specialActionEntries.length === 0 ? _jsx("p", { className: "section-help", children: "Sin acciones especiales registradas." }) : null] })) : null, activeActionTab !== "special" ? (_jsxs(_Fragment, { children: [filteredActions.map((action) => (_jsxs("div", { className: "campaign-action-button campaign-action-button--row", children: [_jsxs("div", { className: "campaign-action-main", children: [_jsxs("div", { className: "campaign-action-title-row", children: [_jsx("button", { type: "button", className: `campaign-action-favorite-toggle${favoriteActionIds.has(action.id) ? " is-active" : ""}`, onClick: () => toggleFavoriteAction(action.id), "aria-label": favoriteActionIds.has(action.id) ? "Quitar de favoritas" : "Guardar en favoritas", title: favoriteActionIds.has(action.id) ? "Quitar de favoritas" : "Guardar en favoritas", children: "\u2605" }), _jsx("button", { type: "button", className: "campaign-action-name-button", onClick: () => openActionDetail(action), children: formatActionDisplayLabel(action.label) })] }), _jsx("span", { className: "campaign-action-source-note", children: getActionSourceLabel(action) })] }), renderActionRollControls(action)] }, action.id))), filteredActions.length === 0 ? _jsx("p", { className: "section-help", children: "Sin acciones registradas en esta categoria." }) : null] })) : null] })] }) })) : null, activeTab === "inventory" ? (_jsx("section", { className: "unified-sheet-panel", children: _jsxs("article", { className: "campaign-sheet-card", children: [_jsx("div", { className: "row-actions", children: _jsx("h3", { children: "Inventario y equipo" }) }), _jsx("nav", { className: "unified-sheet-subtabs", "aria-label": "Secciones del inventario", children: [
                                            ["money", "Dinero"],
                                            ["weapons", "Armas"],
                                            ["armors", "Armaduras"],
                                            ["items", "Objetos"]
    ...
    return (_jsxs("div", { className: `unified-sheet is-tab-${activeTab} is-mobile-tab-${mobileActiveTab}`, children: [_jsx("nav", { ref: mobileTabsRef, className: "unified-sheet-mobile-tabs", "aria-label": "Secciones de la ficha", children: [
                    ...
                    ["background", "Trasfondo"],
                    ["notes", "Notas"]
                ].map(([tab, label]) => (_jsx("button", { type: "button", className: mobileActiveTab === tab ? "is-active" : "", "aria-current": mobileActiveTab === tab ? "page" : undefined, onClick: (event) => handleMobileTabChange(tab, event.currentTarget), children: label }, tab))) }), _jsxs("div", { className: "unified-sheet-top-grid", children: [_jsx("section", { className: "unified-sheet-module unified-sheet-identity-module campaign-sheet-card", "aria-label": "Identidad del personaje", children: _jsxs("div", { className: "unified-sheet-hero-main", children: [_jsxs("div", { className: "unified-sheet-portrait", children: [_jsx("div", { className: "unified-sheet-portrait-ring" }), _jsx("div", { className: "unified-sheet-portrait-content", children: _jsx("span", { children: String(normalizedSheet.identidad.arquetipo).slice(0, 1) }) })] }), _jsxs("div", { className: "unified-sheet-identity", children: [_jsx("h2", { className: "unified-sheet-title", children: displayName }), subtitle ? _jsx("span", { className: "unified-sheet-inline-subtitle", children: subtitle }) : null] }), backgroundPreferenceScope || (editable && onOpenBuilder) ? (_jsxs("div", { className: "unified-sheet-header-actions", children: [backgroundPreferenceScope ? _jsx(CharacterSheetBackgroundPicker, { preferenceScope: backgroundPreferenceScope }) : null, editable && onOpenBuilder ? (_jsxs("button", { type: "button", className: "unified-sheet-builder-launch", onClick: onOpenBuilder, children: [_jsx("span", { "aria-hidden": "true", children: "\u2692" }), _jsx("span", { children: "Constructor" })] })) : null] })) : null] }) }), _jsxs("section", { className: "unified-sheet-module unified-sheet-experience-module unified-sheet-xp-card campaign-sheet-card", "aria-labelledby": "unified-sheet-experience-title", children: [_jsx("h2", { id: "unified-sheet-experience-title", className: "unified-sheet-module-title", children: "Experiencia" }), _jsxs("div", { className: "unified-sheet-xp-row", children: [_jsx("span", { children: "PX total" }), _jsx("strong", { children: normalizedSheet.progreso.experienciaTotal })] }), _jsxs("div", { className: "unified-sheet-xp-row is-static", children: [_jsx("span", { children: "PX gastada" }), _jsx("strong", { children: displayedSpentExperience })] }), _jsxs("div", { className: "unified-sheet-xp-row is-static", children: [_jsx("span", { children: "PX disponible" }), _jsx("strong", { children: experience.effectiveAvailable })] })] })] }), _jsxs("section", { className: "unified-sheet-module unified-sheet-resources-module campaign-sheet-card", "aria-labelledby": "unified-sheet-resources-title", children: [_jsx("h2", { id: "unified-sheet-resources-title", className: "unified-sheet-module-title", children: "Recursos" }), _jsxs("div", { className: "unified-sheet-header-stats", children: [_jsxs("div", { className: "unified-sheet-vital-card is-health", children: [_jsxs("div", { className: "unified-sheet-vital-header", children: [_jsx("span", { children: "Robustez" }), _jsxs("strong", { children: [derived.robustezActualTotal, " / ", derived.robustezMaximaTotal] })] }), _jsx("div", { className: "unified-sheet-vital-track", children: _jsx("div", { style: { width: `${Math.min(100, derived.robustezMaximaTotal > 0 ? (derived.robustezActualTotal / derived.robustezMaximaTotal) * 100 : 0)}%` } }) }), editable ? (_jsxs("div", { className: "unified-sheet-vital-actions", children: [_jsx("button", { type: "button", className: "vital-action loss", onClick: () => adjustNumber("combate.robustezActual", -1), children: "-1 Danio" }), _jsx("button", { type: "button", className: "vital-action gain", onClick: () => adjustNumber("combate.robustezActual", 1), children: "+1 Vida" })] })) : null] }), _jsxs("div", { className: "unified-sheet-vital-card is-corruption", children: [_jsxs("div", { className: "unified-sheet-vital-header", children: [_jsx("span", { children: "Corrupcion temporal" }), _jsx("strong", { children: normalizedSheet.corrupcion.temporal })] }), _jsx("div", { className: "unified-sheet-vital-track", children: _jsx("div", { style: { width: `${Math.min(100, derived.umbralCorrupcionTotal > 0 ? (normalizedSheet.corrupcion.temporal / derived.umbralCorrupcionTotal) * 100 : 0)}%` } }) }), editable ? (_jsxs("div", { className: "unified-sheet-vital-actions", children: [_jsx("button", { type: "button", className: "vital-action recovery", onClick: () => adjustNumber("corrupcion.temporal", -1), children: "-1 Temp" }), _jsx("button", { type: "button", className: "vital-action corruption", onClick: () => adjustNumber("corrupcion.temporal", 1), children: "+1 Temp" })] })) : null] }), _jsxs("div", { className: "unified-sheet-vital-card is-corruption-deep", children: [_jsxs("div", { className: "unified-sheet-vital-header", children: [_jsx("span", { children: "Corrupcion permanente" }), _jsx("strong", { children: normalizedSheet.corrupcion.permanente })] }), _jsx("div", { className: "unified-sheet-vital-track", children: _jsx("div", { style: { width: `${Math.min(100, derived.umbralCorrupcionTotal > 0 ? (normalizedSheet.corrupcion.permanente / derived.umbralCorrupcionTotal) * 100 : 0)}%` } }) }), editable ? (_jsxs("div", { className: "unified-sheet-vital-actions", children: [_jsx("button", { type: "button", className: "vital-action recovery", onClick: () => adjustNumber("corrupcion.permanente", -1), children: "-1 Perm" }), _jsx("button", { type: "button", className: "vital-action corruption-deep", onClick: () => adjustNumber("corrupcion.permanente", 1), children: "+1 Perm" })] })) : null] })] })] }), _jsxs("div", { className: "unified-sheet-workspace", children: [_jsxs("aside", { className: "unified-sheet-summary-column", "aria-label": "Resumen del personaje", children: [_jsxs("section", { className: "unified-sheet-module unified-sheet-attributes-module campaign-sheet-card", "aria-labelledby": "unified-sheet-attributes-title", children: [_jsx("h2", { id: "unified-sheet-attributes-title", className: "unified-sheet-module-title", children: "Atributos" }), _jsx("div", { className: "unified-sheet-attribute-rail", children: ATTRIBUTE_KEYS.map((key) => (_jsxs("div", { className: "unified-sheet-attribute-chip", children: [_jsx("span", { children: ATTRIBUTE_LABELS[key] }), _jsx("strong", { children: normalizedSheet.atributos[key] }), isReadOnly ? null : _jsx("button", { type: "button", className: "vital-action subtle", onClick: () => runAttributeRoll(key), children: "Tirar" })] }, key))) })] }), _jsxs("div", { className: "unified-sheet-static-summary", children: [_jsxs("section", { className: "unified-sheet-module unified-sheet-combat-module campaign-sheet-card", "aria-labelledby": "unified-sheet-combat-title", children: [_jsx("h2", { id: "unified-sheet-combat-title", className: "unified-sheet-module-title", children: "Combate" }), _jsxs("div", { className: "unified-sheet-quick-row is-primary", children: [_jsxs("article", { className: "unified-sheet-quick-card is-defense-card", children: [_jsxs("div", { className: "row-actions", children: [_jsx("h3", { children: "Defensa" }), _jsx("strong", { children: derived.defensaTotal })] }), derived.defensaArmaduraDetalle ? _jsx("p", { className: "section-help", children: derived.defensaArmaduraDetalle }) : null, isReadOnly ? null : (_jsx("div", { className: "unified-sheet-vital-actions", children: _jsx("button", { type: "button", className: "vital-action subtle is-defense-roll", onClick: runDefenseRoll, children: "Tirar Defensa" }) }))] }), _jsxs("article", { className: "unified-sheet-quick-card", children: [_jsxs("div", { className: "row-actions", children: [_jsx("h3", { children: "Armadura" }), _jsx("strong", { children: activeArmor?.protectionFormula || derived.armaduraActiva || "-" })] }), _jsx("strong", { children: activeArmor?.name || normalizedSheet.combate.armadura || (derived.armaduraNatural ? "Armadura natural" : "Sin armadura") }), isReadOnly ? null : (_jsx("div", { className: "unified-sheet-vital-actions", children: _jsx("button", { type: "button", className: "vital-action subtle", onClick: runArmorRoll, disabled: !(activeArmor?.protectionFormula || derived.armaduraActiva), children: "Tirar Armadura" }) }))] })] })] }), _jsxs("section", { className: "unified-sheet-module unified-sheet-derived-module campaign-sheet-card", "aria-labelledby": "unified-sheet-derived-title", children: [_jsx("h2", { id: "unified-sheet-derived-title", className: "unified-sheet-module-title", children: "Valores derivados" }), _jsxs("div", { className: "unified-sheet-quick-row is-derived", children: [_jsxs("article", { className: "unified-sheet-quick-card is-derived-card", children: [_jsx("h3", { children: "Iniciativa" }), _jsx("strong", { children: derived.iniciativaTotal })] }), _jsxs("article", { className: "unified-sheet-quick-card is-derived-card", children: [_jsx("h3", { children: "Umbral de corrupcion" }), _jsx("strong", { children: derived.umbralCorrupcionTotal })] }), _jsxs("article", { className: "unified-sheet-quick-card is-derived-card", children: [_jsx("h3", { children: "Umbral de dolor" }), _jsx("strong", { children: derived.umbralDolorTotal })] })] })] }), _jsxs("section", { className: "unified-sheet-module unified-sheet-conditions-module campaign-sheet-card", "aria-labelledby": "unified-sheet-conditions-title", children: [_jsx("h2", { id: "unified-sheet-conditions-title", className: "unified-sheet-module-title", children: "Condiciones" }), _jsx("div", { className: "unified-sheet-quick-row is-conditions", children: _jsx("article", { className: "unified-sheet-quick-card is-wide", children: _jsx("div", { className: "unified-sheet-quick-tags", children: normalizedSheet.conditions.length > 0 ? normalizedSheet.conditions.slice(0, 4).map((condition) => (_jsx("span", { className: `unified-sheet-tag is-${condition.category}`, children: condition.name || "Condicion" }, condition.id))) : _jsx("span", { className: "unified-sheet-tag", children: "Sin condiciones" }) }) }) })] })] })] }), renderTabStage("unified-sheet-module unified-sheet-reader unified-sheet-stage unified-sheet-dynamic-column campaign-sheet-card")] }), selectedPersonalNote ? (_jsx("div", { className: "modal-backdrop", onClick: () => setSelectedPersonalNoteId(null), children: _jsxs("div", { className: "panel modal-panel character-roll-confirm-modal unified-sheet-action-detail-modal", onClick: (event) => event.stopPropagation(), children: [_jsx("h3", { children: selectedPersonalNote.title }), _jsxs("p", { className: "section-help", children: ["Actualizada ", selectedPersonalNote.updatedAt || selectedPersonalNote.createdAt || "sin fecha"] }), _jsx("div", { className: "unified-sheet-action-detail-body", children: _jsx("div", { className: "campaign-markdown", children: renderSimpleMarkdownBlocks(selectedPersonalNote.content || "Sin contenido detallado.") }) }), _jsxs("div", { className: "row-actions character-roll-confirm-actions", children: [canEditNotes ? (_jsx("button", { type: "button", onClick: () => {
                                        setPersonalNoteError(null);
