...
export const SYMBAROUM_ABILITIES: SymbaroumCapability[] = [
  makeCapability("habilidad", "Acróbata", LIBRO_BASICO, 116),
  makeCapability("habilidad", "Alquimista", LIBRO_BASICO, 116),
  makeCapability("habilidad", "Arco veloz", GUIA_AVANZADA, 67),
  makeCapability("habilidad", "Armas a dos manos", LIBRO_BASICO, 116),
  makeCapability("habilidad", "Armas de asta", LIBRO_BASICO, 116),
  makeCapability("habilidad", "Armas de presa", GUIA_AVANZADA, 67),
  makeCapability("habilidad", "Ataque con dos armas", LIBRO_BASICO, 116),
  makeCapability("habilidad", "Ataque traicionero", LIBRO_BASICO, 116),
  makeCapability("habilidad", "Atributo excepcional", LIBRO_BASICO, 116),
  makeCapability("habilidad", "Berserker", LIBRO_BASICO, 116),
  makeCapability("habilidad", "Brujería", LIBRO_BASICO, 116),
  makeCapability("habilidad", "Canalización", GUIA_AVANZADA, 67),
  makeCapability("habilidad", "Canto Troll", GUIA_AVANZADA, 67),
  makeCapability("habilidad", "Capa danzante", GUIA_AVANZADA, 67),
  makeCapability("habilidad", "Combate con arma larga", GUIA_AVANZADA, 67),
  makeCapability("habilidad", "Combate con armadura", LIBRO_BASICO, 116),
  makeCapability("habilidad", "Combate con armas de cadena", GUIA_AVANZADA, 67),
  makeCapability("habilidad", "Combate con escudo", LIBRO_BASICO, 116),
  makeCapability("habilidad", "Combate sangriento", GUIA_AVANZADA, 67),
  makeCapability("habilidad", "Combate sin armas", LIBRO_BASICO, 116),
  makeCapability("habilidad", "Cuchillo rápido", GUIA_AVANZADA, 67),
  makeCapability("habilidad", "Danza de batalla", GUIA_AVANZADA, 67),
  makeCapability("habilidad", "Disparo magistral", GUIA_AVANZADA, 67),
  ...
  makeCapability("habilidad", "Lucha", GUIA_AVANZADA, 67),
  ...
  makeCapability("habilidad", "Medicus", LIBRO_BASICO, 116),
  ...
  makeCapability("habilidad", "Rituales", LIBRO_BASICO, 116),
  ...
  makeCapability("habilidad", "Venenos", LIBRO_BASICO, 116),
...
export const SYMBAROUM_MYSTIC_POWERS: SymbaroumCapability[] = [
  makeCapability("poder_mistico", "Aliento negro", GUIA_AVANZADA, 81, ["Hechicería"]),
  makeCapability("poder_mistico", "Anatema", GUIA_AVANZADA, 81, ["Magia", "Magia del báculo", "Teúrgia"]),
  makeCapability("poder_mistico", "Arma danzante", GUIA_AVANZADA, 81, ["Magia del báculo", "Canto Troll"]),
  ...
  makeCapability("poder_mistico", "Báculo arrojadizo", GUIA_AVANZADA, 81, ["Magia del báculo"]),
  ...
  makeCapability("poder_mistico", "Esfera de protección", GUIA_AVANZADA, 81, ["Magia del báculo"]),
...
export const SYMBAROUM_RITUALS: SymbaroumCapability[] = [
  makeCapability("ritual", "Adivinación", GUIA_AVANZADA, 91, ["Brujería"]),
  makeCapability("ritual", "Adivinación nigromántica", GUIA_AVANZADA, 91, ["Espiritistas"]),
  makeCapability("ritual", "Alzar muertos vivientes", GUIA_AVANZADA, 91, ["Hechicería"]),
  ...
  makeCapability("ritual", "Compañero bestial", GUIA_AVANZADA, 91, ["Nómadas de la sangre"]),
  ...
  makeCapability("ritual", "Escritura lejana", GUIA_AVANZADA, 91, ["Simbolismo"]),
  makeCapability("ritual", "Espíritu protector", GUIA_AVANZADA, 91, ["Teúrgia"]),
  makeCapability("ritual", "Exorcismo", GUIA_AVANZADA, 91, ["Teúrgia"]),
  makeCapability("ritual", "Expiación", GUIA_AVANZADA, 91, ["Confesores"]),
  makeCapability("ritual", "Familiar", GUIA_AVANZADA, 91, ["Brujería"]),
  makeCapability("ritual", "Fata morgana", GUIA_AVANZADA, 91, ["Ilusionistas"]),
  makeCapability("ritual", "Forma ilusoria", GUIA_AVANZADA, 91, ["Magia"]),
  ...
  makeCapability("ritual", "Ilusión", GUIA_AVANZADA, 91, ["Magia"]),
  ...
  makeCapability("ritual", "Nigromancia", GUIA_AVANZADA, 91, ["Brujería"]),
  ...
  makeCapability("ritual", "Terreno ilusorio", GUIA_AVANZADA, 91, ["Magia"]),
  ...
  makeCapability("ritual", "Vínculo de sangre", GUIA_AVANZADA, 91, ["Brujería"]),
