...
export const WEAPON_QUALITY_OPTIONS: WeaponQualityOption[] = [
  { id: "corta", label: "Corta", summary: "Arma corta apta para combate cerrado y tecnicas que exigen poca longitud.", details: "Las armas cortas suelen ser faciles de ocultar, pelear en espacios estrechos y aprovechar estilos de esgrima rapida." },
  { id: "larga", label: "Larga", summary: "Otorga alcance superior y ventaja frente a enemigos que no empunen armas largas.", details: "Las armas largas permiten ataques gratuitos contra enemigos que entren a cuerpo a cuerpo sin usar otra arma larga; empunadas con una sola mano suelen perder esta cualidad." },
  { id: "precisa", label: "Precisa", summary: "Favorece golpes tecnicos, estocadas y disparos equilibrados.", details: "La cualidad representa un arma especialmente controlable o bien balanceada, util en estilos que premian precision por encima de la fuerza bruta." },
  ...
  { id: "equilibrada", label: "Equilibrada", summary: "Su balance facilita ataques rapidos, desenvainados y combinaciones.", details: "Un arma equilibrada mantiene buen control entre ofensiva y manejo, ideal para estilos agiles o de doble arma." },
  ...
  { id: "perforante", label: "Perforante", summary: "Pensada para atravesar defensas y aprovechar huecos en la armadura.", details: "Representa puntas o cabezas de impacto concentrado capaces de forzar protecciones y armaduras." },
  { id: "impacto-agravado", label: "Impacto agravado", summary: "Golpea con especial violencia cuando el impacto conecta con fuerza.", details: "Se usa como una etiqueta general para armas o proyectiles cuya pegada supera a la de su categoria base." },
  { id: "profunda", label: "Profunda", summary: "Provoca heridas severas y dificiles de tratar.", details: "Equivale al comportamiento de armas disenadas para penetrar con gran profundidad o dejar heridas criticas." },
  { id: "sangrado", label: "Sangrado", summary: "Puede abrir heridas que dejen al objetivo sangrando.", details: "Representa cabezas, filos o martillos pensados para provocar perdida continuada de sangre." },
  { id: "roma", label: "Roma", summary: "Preparada para someter, aturdir o capturar sin matar con facilidad.", details: "Sirve para danio contundente y control, en vez de profundizar heridas letales." },
  ...
  { id: "masiva", label: "Masiva", summary: "Arma muy voluminosa o brutal, dificil de manejar pero devastadora.", details: "Se asocia a armas de ejecucion, guerra pesada o asedio personal; su presencia suele imponer limitaciones practicas." },
  { id: "torpe", label: "Torpe", summary: "Cuesta maniobrarla con rapidez y exige espacio o preparacion.", details: "Modela armas lentas, poco practicas o aparatosas; suelen compensarlo con impacto, alcance o efectos especiales." },
  { id: "articulada", label: "Articulada", summary: "La cabeza o tramo flexible hace dificil bloquear su trayectoria.", details: "Manguales y armas similares rodean escudos o paradas con facilidad gracias a su cadena o union flexible." },
  { id: "oculta", label: "Oculta", summary: "Se disimula con facilidad en ropa, vainas pequenas o sobre el cuerpo.", details: "Pensada para asesinos, maleantes y armas secundarias que deben pasar desapercibidas." },
  { id: "enredadora", label: "Enredadora", summary: "Puede atrapar o inmovilizar al objetivo en vez de limitarse a herirlo.", details: "Latigos, cadenas y proyectiles especiales usan esta cualidad para frenar, sujetar o complicar movimientos." },
  { id: "contundente", label: "Contundente", summary: "Inflige golpes romos, empuja o aturde mas que cortar.", details: "Ideal para bastones, mazas y latigos pesados que castigan sin depender del filo." },
  { id: "flexible", label: "Flexible", summary: "Se adapta a golpes rapidos, desvio y defensa agil.", details: "Suele aparecer en escudos ligeros y protecciones o armas pensadas para movilidad." },
  ...
  { id: "retornante", label: "Retornante", summary: "Si falla, puede volver hacia el lanzador con una tirada adecuada.", details: "Describe armas arrojadizas disenadas para regresar a la mano del usuario o a su posicion." }
];
...
export const WEAPON_TEMPLATES: WeaponTemplate[] = [
  ...
  makeWeaponTemplate({ templateId: "weapon-dagger", name: "Daga", description: "Arma corta facil de ocultar y util como secundaria o en pelea cerrada.", slot: "offHand", attackAttribute: "diestro", damageFormula: "1d6", qualities: ["Corta", "Precisa"], weight: "Ligera", value: "1 talero", notes: "Equivalente habitual a un arma corta refinada para estocadas." }),
  ...
  makeWeaponTemplate({ templateId: "weapon-assassins-blade", name: "Cuchilla de asesino", description: "Hoja delgada y facil de esconder en la muneca, tobillo o tras la nuca.", slot: "offHand", attackAttribute: "discreto", damageFormula: "1d6", qualities: ["Corta", "Oculta"], weight: "Ligera", value: "5 taleros", notes: "Ref: Guia Avanzada del Jugador p. 111." }),
  makeWeaponTemplate({ templateId: "weapon-stiletto", name: "Estilete", description: "Punal estrecho hecho para entrar entre placas y costuras de armadura.", slot: "offHand", attackAttribute: "diestro", damageFormula: "1d6+1", qualities: ["Corta", "Perforante"], weight: "Ligera", value: "5 taleros", notes: "Ref: Libro Basico p. 149; Guia Avanzada del Jugador p. 111." }),
  makeWeaponTemplate({ templateId: "weapon-battle-claw", name: "Garra de batalla", description: "Arma de punio o guantelete con hoja corta, util cuando no se quiere soltar otra cosa.", slot: "offHand", attackAttribute: "diestro", damageFormula: "1d4+1", qualities: ["Corta", "Perforante"], weight: "Ligera", value: "1 talero", notes: "Ref: Libro Basico p. 149; Guia Avanzada del Jugador p. 111." }),
  makeWeaponTemplate({ templateId: "weapon-short-sword", name: "Espada corta", description: "Espada ligera para pelea cerrada o mano secundaria.", slot: "mainHand", attackAttribute: "diestro", damageFormula: "1d6", qualities: ["Precisa"], weight: "Ligera", value: "4 taleros", notes: "Variante comun de arma de una mano para entornos cerrados." }),
  makeWeaponTemplate({ templateId: "weapon-long-sword", name: "Espada larga", description: "Arma versatil de una mano, comun entre aventureros y soldados.", slot: "mainHand", attackAttribute: "diestro", damageFormula: "1d8", qualities: ["Precisa"], weight: "Media", value: "8 taleros", notes: "Variante comun de arma de una mano refinada para guardias y duelistas." }),
  makeWeaponTemplate({ templateId: "weapon-fencing-sword", name: "Espada de esgrima", description: "Hoja agil de duelos y estocadas rapidas.", slot: "mainHand", attackAttribute: "diestro", damageFormula: "1d8", qualities: ["Precisa"], weight: "Ligera", value: "25 taleros", notes: "Ref: Libro Basico p. 149; Guia Avanzada del Jugador p. 110." }),
  makeWeaponTemplate({ templateId: "weapon-estoc", name: "Estoque", description: "Espada estrecha acabada en punta de cuna para perforar armaduras.", slot: "mainHand", attackAttribute: "diestro", damageFormula: "1d8+1", qualities: ["Perforante", "Precisa"], weight: "Media", value: "25 taleros", notes: "Ref: Guia Avanzada del Jugador p. 110." }),
  makeWeaponTemplate({ templateId: "weapon-crows-beak", name: "Pico de cuervo", description: "Martillo-pico concentrado en perforar armadura y cascos.", slot: "mainHand", attackAttribute: "fuerte", damageFormula: "1d8+1", qualities: ["Perforante"], weight: "Media", value: "25 taleros", notes: "Ref: Libro Basico p. 149; Guia Avanzada del Jugador p. 110." }),
  ...
  makeWeaponTemplate({ templateId: "weapon-mace", name: "Maza", description: "Arma contundente para romper guardias y cascos.", slot: "mainHand", attackAttribute: "fuerte", damageFormula: "1d8", qualities: ["Roma"], weight: "Media", value: "5 taleros", notes: "Variante comun de arma de una mano centrada en impacto." }),
  ...
  makeWeaponTemplate({ templateId: "weapon-quarterstaff", name: "Vara", description: "Baston de madera endurecida con fuego, de largo alcance y uso sencillo.", slot: "mainHand", attackAttribute: "diestro", damageFormula: "1d6", qualities: ["Larga", "Contundente", "Equilibrada"], weight: "Media", value: "1 chelin", notes: "Ref: Libro Basico p. 149; Guia Avanzada del Jugador p. 111." }),
  makeWeaponTemplate({ templateId: "weapon-chain-staff", name: "Vara encadenada", description: "Baston con cadenas cortas en los extremos para atrapar y azotar al objetivo.", slot: "mainHand", attackAttribute: "diestro", damageFormula: "1d8", qualities: ["Larga", "Enredadora"], weight: "Media", value: "15 taleros", notes: "Ref: Guia Avanzada del Jugador p. 112." }),
  ...
  makeWeaponTemplate({ templateId: "weapon-long-whip", name: "Latigo largo", description: "Latigo adaptado del pastoreo y la esclavitud para herir, trabar y castigar a distancia.", slot: "mainHand", attackAttribute: "diestro", damageFormula: "1d6", qualities: ["Articulada", "Enredadora", "Contundente"], weight: "Ligera", value: "10 taleros", notes: "Ref: Guia Avanzada del Jugador p. 112." }),
  ...
  makeWeaponTemplate({ templateId: "weapon-horsemans-bow", name: "Arco de jinete", description: "Arco asimetrico disenado para disparar a caballo sin perder demasiada pegada.", slot: "ranged", attackAttribute: "diestro", damageFormula: "1d8", qualities: ["A distancia", "Precisa"], weight: "Media", value: "50 taleros", notes: "Ref: Guia Avanzada del Jugador p. 112." }),
  makeWeaponTemplate({ templateId: "weapon-composite-bow", name: "Arco compuesto", description: "Arco de cuerno, tendones y madera con gran potencia para su tamano.", slot: "ranged", attackAttribute: "diestro", damageFormula: "1d8+1", qualities: ["A distancia", "Perforante"], weight: "Media", value: "25 taleros", notes: "Muy apreciado entre pueblos jinetes. Ref: Guia Avanzada del Jugador p. 112." }),
  ...
  makeWeaponTemplate({ templateId: "weapon-arbalest", name: "Arbalesta", description: "Ballesta de gran penetracion para tiradores que priorizan potencia sobre cadencia.", slot: "ranged", attackAttribute: "diestro", damageFormula: "1d10+1", qualities: ["A distancia", "Perforante", "Recarga"], weight: "Pesada", value: "40 taleros", notes: "Ref: Libro Basico p. 149; Guia Avanzada del Jugador p. 112." }),
  makeWeaponTemplate({ templateId: "weapon-small-crossbow", name: "Ballesta pequena", description: "Version escondible de la ballesta, disparable con una mano pero recargada con dos.", slot: "ranged", attackAttribute: "discreto", damageFormula: "1d10", qualities: ["A distancia", "Oculta", "Recarga"], weight: "Ligera", value: "40 taleros", notes: "Se puede disparar con una mano pero no cargar con una sola. Ref: Guia Avanzada del Jugador p. 112." }),
  ...
  makeWeaponTemplate({ templateId: "weapon-spear-sling", name: "Honda de lanza", description: "Correa para impulsar lanzas o dardos con fuerza muy superior a la del brazo.", slot: "ranged", attackAttribute: "diestro", damageFormula: "1d6+1", qualities: ["A distancia", "Perforante"], weight: "Ligera", value: "10 taleros", notes: "Ref: Libro Basico p. 149; Guia Avanzada del Jugador p. 112." })
];
...
export function findWeaponQualityOption(value: string): WeaponQualityOption | undefined {
  ...
  return WEAPON_QUALITY_OPTIONS.find((entry) => entry.id === target || normalizeWeaponQualityId(entry.label) === target);
}
