...
export const WEAPON_QUALITY_OPTIONS: WeaponQualityOption[] = [
  ...
  { id: "pesada", label: "Pesada", summary: "Arma de gran masa orientada a impacto y uso a dos manos.", details: "En la hoja se usa como etiqueta de peso y estilo para armas grandes; suele combinarse con daños altos y otras cualidades exigentes." },
  ...
  { id: "escudo", label: "Escudo", summary: "Proporciona +1 a Defensa mientras está equipado.", details: "Los escudos protegen frente a ataques cuerpo a cuerpo y a distancia y proporcionan +1 a Defensa." },
  { id: "flexible", label: "Flexible", summary: "Puede ceñirse al brazo sin ocupar la mano.", details: "Un escudo Flexible deja ambas manos libres para empuñar un arma larga, pesada o de proyectiles." },
  ...
  { id: "llameante", label: "Llameante", summary: "Puede prender fuego o dejar un efecto continuo de llamas.", details: "Granadas, flechas preparadas y tubos de fuego usan esta cualidad para extender daños o amenazas de incendio." },
...
export const WEAPON_TEMPLATES: WeaponTemplate[] = [
  ...
  makeWeaponTemplate({ templateId: "weapon-thrown", name: "Arma arrojadiza", description: "Categoria base de cuchillos, piedras o armas diseñadas para lanzar.", slot: "none", attackAttribute: "diestro", damageFormula: "1d6", qualities: ["Arrojadiza"], weight: "Ligera", value: "2 taleros", notes: "Ref: Guia Avanzada del Jugador p. 112.", stackable: true, defaultQuantity: 3 }),
  makeWeaponTemplate({ templateId: "weapon-shield", name: "Escudo", description: "Escudo de madera para protegerse de ataques cuerpo a cuerpo y a distancia.", slot: "offHand", attackAttribute: "diestro", damageFormula: "1d4", qualities: ["Escudo"], weight: "Media", value: "3 taleros", notes: "Proporciona +1 a Defensa. Ref: Libro Basico p. 148.", defenseBonus: 1 }),
  makeWeaponTemplate({ templateId: "weapon-steel-shield", name: "Escudo de acero", description: "Escudo de acero fino y resistente, mas facil de utilizar que uno de madera.", slot: "offHand", attackAttribute: "diestro", damageFormula: "1d4", qualities: ["Escudo", "Equilibrada"], weight: "Media", value: "15 taleros", notes: "Proporciona +1 a Defensa por ser escudo y +1 adicional por Equilibrada. Ref: Libro Basico p. 147-148.", defenseBonus: 1 }),
  makeWeaponTemplate({ templateId: "weapon-buckler", name: "Rodela", description: "Escudo pequeño que se ciñe al brazo y deja ambas manos libres.", slot: "offHand", attackAttribute: "diestro", damageFormula: "1d4", qualities: ["Escudo", "Flexible"], weight: "Ligera", value: "15 taleros", notes: "Proporciona +1 a Defensa. No puede usarse con Combate con escudo. Ref: Libro Basico p. 147-148.", defenseBonus: 1 }),
  ...
  makeWeaponTemplate({ templateId: "weapon-assassins-blade", name: "Hoja de asesino", description: "Hoja delgada y facil de esconder en la muñeca, tobillo o tras la nuca.", slot: "offHand", attackAttribute: "discreto", damageFormula: "1d6", qualities: ["Corta", "Ocultable"], weight: "Ligera", value: "5 taleros", notes: "Ref: Guia Avanzada del Jugador p. 111." }),
  makeWeaponTemplate({ templateId: "weapon-stiletto", name: "Estilete", description: "Puñal estrecho hecho para entrar entre placas y costuras de armadura.", slot: "offHand", attackAttribute: "diestro", damageFormula: "1d6+1", qualities: ["Corta", "Impacto agravado"], weight: "Ligera", value: "5 taleros", notes: "Ref: Libro Basico p. 149; Guia Avanzada del Jugador p. 111." }),
  ...
  makeWeaponTemplate({ templateId: "weapon-bow", name: "Arco", description: "Arco comun de proyectiles, base de muchas compañías de hostigadores.", slot: "ranged", attackAttribute: "diestro", damageFormula: "1d8", qualities: ["A distancia"], weight: "Media", value: "5 taleros", notes: "Ref: Libro Basico p. 149; Guia Avanzada del Jugador p. 112." }),
  ...
  makeWeaponTemplate({ templateId: "weapon-horsemans-bow", name: "Arco largo de jinete", description: "Arco asimetrico diseñado para disparar a caballo sin perder demasiada pegada.", slot: "ranged", attackAttribute: "diestro", damageFormula: "1d8", qualities: ["A distancia", "Precisa"], weight: "Media", value: "50 taleros", notes: "Ref: Guia Avanzada del Jugador p. 112." }),
  makeWeaponTemplate({ templateId: "weapon-composite-bow", name: "Arco compuesto", description: "Arco de cuerno, tendones y madera con gran potencia para su tamaño.", slot: "ranged", attackAttribute: "diestro", damageFormula: "1d8+1", qualities: ["A distancia", "Impacto agravado"], weight: "Media", value: "25 taleros", notes: "Muy apreciado entre pueblos jinetes. Ref: Guia Avanzada del Jugador p. 112." }),
