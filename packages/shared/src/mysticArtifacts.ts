...
export type MysticArtifactKind = z.infer<typeof mysticArtifactKindSchema>;
export type MysticArtifactPaymentType = z.infer<typeof mysticArtifactPaymentTypeSchema>;
export type MysticArtifactBindingPaymentType = z.infer<typeof mysticArtifactBindingPaymentTypeSchema>;
export type MysticArtifactWeaponTag = z.infer<typeof mysticArtifactWeaponTagSchema>;
export type MysticArtifactDefinitionInput = z.infer<typeof mysticArtifactDefinitionInputSchema>;
export type CreateCampaignMysticArtifactInput = z.infer<typeof createCampaignMysticArtifactSchema>;
export type UpdateCampaignMysticArtifactInput = z.infer<typeof updateCampaignMysticArtifactSchema>;
export type AssignMysticArtifactOwnerInput = z.infer<typeof assignMysticArtifactOwnerSchema>;
export type BindMysticArtifactInput = z.infer<typeof bindMysticArtifactSchema>;
export type UpdateMysticArtifactResourceInput = z.infer<typeof updateMysticArtifactResourceSchema>;

export type MysticArtifactRoll = z.infer<typeof mysticArtifactRollInputSchema> & { id: string };
export type MysticArtifactRequirement = z.infer<typeof mysticArtifactRequirementInputSchema> & { id: string };
export type MysticArtifactAbility = Omit<z.infer<typeof mysticArtifactAbilityInputSchema>, "rolls" | "requirements"> & {
  id: string;
  rolls: MysticArtifactRoll[];
  requirements: MysticArtifactRequirement[];
  locked: boolean;
  lockReason: string;
};

export type MysticArtifactResource = z.infer<typeof mysticArtifactResourceInputSchema> & { id: string };

export type MysticArtifact = Omit<MysticArtifactDefinitionInput, "abilities" | "resources"> & {
  id: string;
  scope: "preset" | "campaign";
  campaignId: string | null;
  presetSourceId: string | null;
  ownerType: "character" | "npc" | null;
  ownerId: string | null;
  ownerName: string | null;
  ownerEmail: string | null;
  isBound: boolean;
  boundAt: string | null;
  bindingPaymentType: MysticArtifactBindingPaymentType | null;
  bindingPaymentAmount: number | null;
...
export type OwnedMysticArtifact = MysticArtifact & {
  campaignName: string;
};

export type UseMysticArtifactAbilityResult = {
  artifactId: string;
  abilityId: string;
  resources: MysticArtifactResource[];
};
